...
public class PasswordChange extends JFrame implements Serializable{
			...
			if(event.getActionCommand().equals("Submit")){
				if(!check.isSelected()){
					...
					try{
						...
						if(file.exists() && !(name.equals(userName))){
							JOptionPane.showMessageDialog(null,"User Name Already Exists.");
						}
						else if(file.exists() && name.equals(userName)){
